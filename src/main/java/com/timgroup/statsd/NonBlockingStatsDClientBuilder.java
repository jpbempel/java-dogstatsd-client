...
public class NonBlockingStatsDClientBuilder {
    ...
    public boolean disableTelemetry = NonBlockingStatsDClient.DEFAULT_DISABLED_TELEMETRY;
    ...
    public NonBlockingStatsDClientBuilder disableTelemetry(boolean val) {
        disableTelemetry = val;
        return this;
    }
