...
public class TelemetryTest {
    ...
    private static class StatsDNonBlockingTelemetry extends NonBlockingStatsDClient {
        public StatsDNonBlockingTelemetry(final String prefix, final int queueSize, String[] constantTags,
                                       ...
                                       final int senderWorkers, boolean blocking, final boolean disableTelemetry,
                ...
                super(prefix, queueSize, constantTags, errorHandler, addressLookup, timeout, bufferSize,
                        ...
                        disableTelemetry, telemetryFlushInterval);
        }
    };
        ...
        public StatsDNonBlockingTelemetry build() throws StatsDClientException {
            if (addressLookup != null) {
                return new StatsDNonBlockingTelemetry(prefix, queueSize, constantTags, errorHandler,
                        ...
                        bufferPoolSize, processorWorkers, senderWorkers, blocking, disableTelemetry,
                        telemetryFlushInterval);
            } else {
                return new StatsDNonBlockingTelemetry(prefix, queueSize, constantTags, errorHandler,
                        staticStatsDAddressResolution(hostname, port), timeout, socketBufferSize, maxPacketSizeBytes,
                        entityID, bufferPoolSize, processorWorkers, senderWorkers, blocking, disableTelemetry,
                        telemetryFlushInterval);
            }
        }
    }
    ...
    private static final NonBlockingStatsDClientBuilder builder = new StatsDNonBlockingTelemetryBuilder()
        ...
        .disableTelemetry(true); // disable telemetry so we can control calls to "flush"
    ...
    @Test(timeout = 5000L)
     public void telemetry_incrManuallyIncrData() throws Exception {
        ...
        assertThat(fakeProcessor.messages,
    ...
    public void telemetry_flushInterval() throws Exception {
        ...
        assertThat(fakeProcessor.messages, hasItem("datadog.dogstatsd.client.metrics:1|c|#test," + telemetryTags));
        assertThat(fakeProcessor.messages, hasItem("datadog.dogstatsd.client.events:0|c|#test," + telemetryTags));
        assertThat(fakeProcessor.messages, hasItem("datadog.dogstatsd.client.service_checks:0|c|#test," + telemetryTags));
        assertThat(fakeProcessor.messages, hasItem("datadog.dogstatsd.client.bytes_sent:0|c|#test," + telemetryTags));
        assertThat(fakeProcessor.messages, hasItem("datadog.dogstatsd.client.bytes_dropped:0|c|#test," + telemetryTags));
        assertThat(fakeProcessor.messages, hasItem("datadog.dogstatsd.client.packets_sent:0|c|#test," + telemetryTags));
        assertThat(fakeProcessor.messages, hasItem("datadog.dogstatsd.client.packets_dropped:0|c|#test," + telemetryTags));
        assertThat(fakeProcessor.messages, hasItem("datadog.dogstatsd.client.packets_dropped_queue:0|c|#test," + telemetryTags));
    }
